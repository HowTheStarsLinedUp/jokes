...
class JsonReaderTest extends TestCase
{
    ...
    public function testJsonReader()
    {
        ...
        $dotEnv->init();
        $jokesDstFile = $dotEnv->projectDir . DIRECTORY_SEPARATOR . 'tests' . DIRECTORY_SEPARATOR . 'jokesExample.json';
        $jokes = (new JsonReader())->read($jokesDstFile);
        $this->assertEquals($this->expected, $jokes);
    }
}
